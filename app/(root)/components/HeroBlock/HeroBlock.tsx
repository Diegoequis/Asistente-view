...
export default function HeroBlock() {
  return (
    ...
    />
            ...
            mb-12 max-w-xl mx-auto leading-relaxed text-center">
            Prepare for you next job with realistic interview simulations 
            and actionable feedback.    
            </p>

            <div className="flex items-center justify-center pb-5">
                <Button className="bg-purple-600 text-white rounded-lg
                px-20 py-6 text-lg font-semibold shadow-lg transition 
            ...
            <div className=" flex items-center gap-8 text-sm text-slate-200
            justify-center">
