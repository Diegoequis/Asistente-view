  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 text-black">
              ...
              <Select onValueChange={field.onChange} defaultValue={field.value}>
                ...
                <SelectContent>
                  {difficulties.map((level) => (
                    <SelectItem key={level.label} value={level.value}>{level.label}</SelectItem>
        ...
        <Button type="submit" className="w-full bg-gradient-to-r from-purple-600 to-blue-600 font-bold
        py-3 px-6 rounded-lg hover:from-purple-700 hover:to-blue-700 transition-all duration-300">Start interview
          <Mic />
        </Button>
      </form>
    </Form>
